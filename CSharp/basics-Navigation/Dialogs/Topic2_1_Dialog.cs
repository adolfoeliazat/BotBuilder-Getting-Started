...
namespace NavigationBot.Dialogs
{
    ...
    public class Topic2_1_Dialog : IDialog<object>
    {
        public async Task StartAsync(IDialogContext context)
        {
            PromptDialog.Choice(context, this.FirstPromptResumeAfter, new[] { Resources.MoreReply }, "Topic 2.1 Dialog dialog text...", "I'm sorry, I don't understand. Please try again.");
        }
        ...
        private async Task FirstPromptResumeAfter(IDialogContext context, IAwaitable<string> result)
        {
            try
            {
                ...
                {
                    PromptDialog.Choice(context, this.SecondPromptResumeAfter, new[] { Resources.MoreReply }, "Topic 2.1 Dialog second dialog text...", "I'm sorry, I don't understand. Please try again.");
                }
            }
        ...
        private async Task SecondPromptResumeAfter(IDialogContext context, IAwaitable<string> result)
        {
            try
            {
                ...
                if (message == Resources.MoreReply)
                {
                    PromptDialog.Choice(context, this.ThirdPromptResumeAfter, new[] { Resources.MoreReply }, "Topic 2.1 Dialog third dialog text...", "I'm sorry, I don't understand. Please try again.");
                }
            }
            catch (TooManyAttemptsException)
            {
