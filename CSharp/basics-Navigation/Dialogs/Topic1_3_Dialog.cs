...
namespace NavigationBot.Dialogs
{
    ...
    public class Topic1_3_Dialog : IDialog<object>
    {
        ...
        {
            PromptDialog.Choice(context, this.FirstPromptResumeAfter, new[] { Resources.MoreReply }, "SubBot 1.3 Dialog dialog text...", "I'm sorry, I don't understand. Please try again.");
        }
        ...
        private async Task FirstPromptResumeAfter(IDialogContext context, IAwaitable<string> result)
        {
            try
            {
                ...
                {
                    PromptDialog.Choice(context, this.SecondPromptResumeAfter, new[] { Resources.MoreReply }, "SubBot 1.3 Dialog second dialog text...", "I'm sorry, I don't understand. Please try again.");
                }
            }
        ...
        private async Task SecondPromptResumeAfter(IDialogContext context, IAwaitable<string> result)
        {
            try
            {
                ...
                if (message == Resources.MoreReply)
                {
                    PromptDialog.Choice(context, this.ThirdPromptResumeAfter, new[] { Resources.MoreReply }, "SubBot 1.3 Dialog third dialog text...", "I'm sorry, I don't understand. Please try again.");
                }
            }
            catch (TooManyAttemptsException)
            {
